...
- **Host**: Remote
- **Dates and times**:
    - 10:30 to 11:30 EST (America/New\_York) on 09 March 2025
...
1. Opening, welcome, and roll call (Chair)
    ...
    1. Approval of [previous meeting minutes (2025-02-06)](2025-02-06-minutes.md)
    1. Introduction of new attendees
    1. Announcements
1. Review promotions
   * feat: support multi license mix - <https://github.com/CycloneDX/specification/pull/582>
   * feat: license expression details and properties - <https://github.com/CycloneDX/specification/pull/599>
...
1. reminder: next meeting might be timed differently than usual, due to Daylight Saving Times 
