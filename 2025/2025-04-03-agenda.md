...
- **Host**: Remote
- **Dates and times**:
    - 10:30 to 11:30 EST (America/New\_York) on 03 April 2025
...
1. Opening, welcome, and roll call (Chair)
    ...
    1. Approval of [previous meeting minutes (2025-03-06)](2025-03-06-minutes.md)
...
1. Review promotions
   * licenses: allow mix of multiple SPDX expressions AND/OR multiple named/spdx licenses - <https://github.com/CycloneDX/specification/pull/582>
     * postponed vote from previous meeting
   * feat: support for external components with version-ranges - <https://github.com/CycloneDX/specification/pull/586>
